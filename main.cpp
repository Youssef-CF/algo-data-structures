...
{  Node*ptr=head;
    ...
    if (head==NULL)
    {
        new_node=head;return head;return head;
           ...
           case 5:
             {
               ...
               cin>>n;
               chercher(head,n);break;
             }
           case 6:
            {
                cout<<"donner la valeure pour suprimer: ";
                cin>>n;
                suprimer(head,n);break;
            }
           case 7:
             { delete_list(head);break;}
